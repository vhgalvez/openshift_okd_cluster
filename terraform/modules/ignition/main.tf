...
resource "libvirt_volume" "bootstrap_ignition" {
  name   = "bootstrap.ign"
  pool   = "default"
  source = "${path.module}/../../ignition_configs/bootstrap.ign" // Ensure this path is correct
  format = "raw"
}
...
resource "libvirt_volume" "master_ignition" {
  name   = "master.ign"
  pool   = "default"
  source = "${path.module}/../../ignition_configs/master.ign" // Ensure this path is correct
  format = "raw"
}
